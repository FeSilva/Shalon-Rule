    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <h4 class="card-title mb-1">Recuperação de Senha🔒</h4>
          <p class="card-text mb-2">Sua nova senha deve ser diferente das senhas usadas anteriormente.</p>
          ...
          <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-1">
              <div class="d-flex justify-content-between">
                <label class="form-label" for="reset-password-new">Nova Senha</label>
              </div>
            ...
            <div class="mb-1">
              <div class="d-flex justify-content-between">
                <label class="form-label" for="reset-password-confirm">Confirmação de Senha</label>
              </div>
