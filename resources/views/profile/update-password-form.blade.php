<x-jet-form-section submit="updatePassword">
  ...
  <x-slot name="form">
    <div class="mb-1">
      <x-jet-label class="form-label" for="current_password" value="{{ __('Senha Atual') }}" />
    ...
    <div class="mb-1">
      <x-jet-label class="form-label" for="password" value="{{ __('Nova Senha') }}" />
    ...
    <div class="mb-1">
      <x-jet-label class="form-label" for="password_confirmation" value="{{ __('Confirmação de Senha') }}" />
