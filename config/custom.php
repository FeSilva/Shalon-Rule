...
return [
    'custom' => [
        'mainLayoutType' => 'bordered', // Options[String]: vertical(default), horizontal
        ...
        'defaultLanguage' => 'pt',    //en(default)/de/pt/fr here are four optional language provided in theme
